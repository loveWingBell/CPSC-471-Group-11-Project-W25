...
class Medical_Condition(models.Model):
    condition_name = models.CharField(max_length=30, blank=False)
...
class Pill(models.Model):
    pill_name = models.CharField(max_length=30, blank=False)
...
class Prescription(models.Model):
    ...
    pill = models.ForeignKey(Pill, on_delete=models.CASCADE, blank=False)
    pharmacist = models.ForeignKey(Pharmacist, on_delete=models.SET_NULL, null=True, blank=True)
    pill_count = models.PositiveSmallIntegerField(blank=False)
    pill_refills = models.PositiveSmallIntegerField(default=0)
    concentration = models.PositiveSmallIntegerField(blank=False)
